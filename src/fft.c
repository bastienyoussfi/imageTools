...
static int fournFFT( double *data, long nn[], int ndim, int direct) {  // Direct = 1 for the transform, -1 for the inverse transform
   int idim;
...
/* Gray image. Images MUST have their dimensions all powers of 2 -> reshape. */
...
/* Shifting the frames of ims (real and imaginary) into imd (real and imaginary) */
